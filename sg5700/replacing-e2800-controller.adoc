...
* Si tous les disques sont sécurisés, vous avez passé en revue les étapes de la procédure de remplacement du contrôleur E2800 Series simplex, Cela inclut le téléchargement et l'installation de E-Series SANtricity System Manager depuis le site de support NetApp, puis l'utilisation de la fenêtre de gestion d'entreprise (EMW) pour déverrouiller les disques sécurisés après le remplacement du contrôleur.
+
