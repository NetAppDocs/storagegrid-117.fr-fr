...
. link:../commonhardware/changing-mtu-setting.html["Modifiez les paramètres MTU"] Si nécessaire, pour s'assurer qu'ils sont identiques pour l'interface réseau Grid (eth0) sur tous les nœuds.
+
...
*** link:../sg100-1000/changing-link-configuration-of-services-appliance.html["SG100 et SG1000"]
...
NOTE: Voir aussi link:../commonhardware/changing-mtu-setting.html["Modifier le paramètre MTU"].
...
Pour plus d'informations sur l'activation du clonage MAC, reportez-vous aux instructions de link:../rhel/configuring-host-network.html["Red Hat Enterprise Linux ou CentOS"] ou link:../ubuntu/configuring-host-network.html["Ubuntu ou Debian"].
...
Pour plus d'informations sur l'utilisation du mode promiscuous, reportez-vous aux instructions de link:../rhel/configuring-host-network.html["Red Hat Enterprise Linux ou CentOS"] ou link:../ubuntu/configuring-host-network.html["Ubuntu ou Debian"].
