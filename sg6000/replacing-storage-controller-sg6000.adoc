...
== Ste 2 : mettre le contrôleur hors ligne
...
IMPORTANT: *Perte possible de l'accès aux données et#8212;* si les deux numéros de pièce ne sont pas les mêmes, ne pas tenter cette procédure.
