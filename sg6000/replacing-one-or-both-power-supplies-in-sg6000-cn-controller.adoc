...
+
.. link:shutting-down-sg6000-cn-controller.html["Arrêtez l'appareil"].
...
. link:../installconfig/connecting-power-cords-and-applying-power-sg6000.html["Branchez les câbles d'alimentation aux unités remplacées et mettez-les sous tension"].
