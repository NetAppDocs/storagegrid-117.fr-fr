...
* Vous avez accès à https://["Téléchargement NetApp : appliance StorageGRID"^].
...
.Étapes
. [[download-santricity-os]] Téléchargez le nouveau fichier du logiciel SANtricity OS depuis le site https://["Téléchargement NetApp : appliance StorageGRID"^].
+
