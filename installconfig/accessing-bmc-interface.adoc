...
. Entrez le nom d'utilisateur et le mot de passe racine en utilisant le mot de passe que vous avez défini lorsque vous link:changing-root-password-for-bmc-interface.html["mot de passe racine par défaut modifié"]:
+
