...
NOTE: Vous pouvez également configurer le système à l'aide du link:../primer/exploring-grid-manager.html["Gestionnaire de grille"] ou le link:overview-of-installation-rest-apis.html["API d'installation"].
