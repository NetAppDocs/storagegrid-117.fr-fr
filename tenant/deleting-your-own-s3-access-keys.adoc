...
* Vous disposez de l'autorisation gérer vos propres informations d'identification S3. Voir link:tenant-management-permissions.html["Autorisations de gestion des locataires"].
