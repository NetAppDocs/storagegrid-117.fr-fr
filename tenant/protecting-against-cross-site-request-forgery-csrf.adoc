...
Pour configurer la protection CSRF, utilisez le link:../admin/using-grid-management-api.html["API de gestion du grid"] ou link:../tenant/understanding-tenant-management-api.html["API de gestion des locataires"].
