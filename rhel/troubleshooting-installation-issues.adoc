...
Pour savoir comment accéder aux fichiers journaux, reportez-vous à la section link:../monitor/collecting-log-files-and-system-data.html["Collecte de fichiers journaux et de données système"].
