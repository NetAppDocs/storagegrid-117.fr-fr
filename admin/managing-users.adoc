...
+
Si un utilisateur appartient à plusieurs groupes, les autorisations sont cumulatives. Voirlink:managing-admin-groups.html["Gérez les groupes d'administration"] pour plus d'informations.
