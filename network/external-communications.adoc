...
Tous les nœuds
 a| 
Fournit le service DNS multicast (mDNS) utilisé pour les changements d'adresse IP sur l'ensemble du réseau et pour la découverte du nœud d'administration principal lors de l'installation, de l'extension et de la récupération.
