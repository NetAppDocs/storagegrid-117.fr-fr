...
---
= Remplacez la pile CMOS du SGF6112
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Avant de commencer
* Vous avez vérifié que la pile CMOS du SGF6112 doit être remplacée.
+
link:verify-component-to-replace.html["Vérifier le composant à remplacer"]

* Vous avez physiquement localisé l'appliance SGF6112 où vous remplacez la pile CMOS dans le centre de données.
+
...
+
image::../media/sgf6112_two-slot-riser_guide-pin.png[Broche de guidage sur la carte système SGF6112 pour montage à deux emplacements]
