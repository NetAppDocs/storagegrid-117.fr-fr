...
Utilisez cette procédure pour identifier l'appareil dont le matériel est défectueux et lequel des composants matériels remplaçables suivants ne fonctionne pas correctement :
...
+
image::../media/nodes_page_hardware_tab_appliance_verify_nic.png[Section relative aux appareils pour les composants matériels]
...
+
link:turning-sgf6112-identify-led-on-and-off.html["Allumez et éteignez le voyant d'identification de l'appareil"]
