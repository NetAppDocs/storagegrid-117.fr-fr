...
---
= Remplacez le ventilateur dans une appliance SGF6112
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Vous avez déterminé l'emplacement du ventilateur à remplacer.
+
link:verify-component-to-replace.html["Vérifier le composant à remplacer"]

* Vous avez physiquement localisé l'appliance SGF6112 où vous remplacez le ventilateur dans le centre de données.
+
