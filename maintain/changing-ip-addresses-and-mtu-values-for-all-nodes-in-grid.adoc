...
IMPORTANT: Vous devez sélectionner *étape*. N'effectuez pas de redémarrage en roulant, soit manuellement, soit en sélectionnant *Apply* au lieu de *stage* ; la grille ne démarrera pas correctement.
