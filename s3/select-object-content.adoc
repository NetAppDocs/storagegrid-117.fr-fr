...
Pour plus d'informations, reportez-vous au https://docs.aws.amazon.com/AmazonS3/latest/API/API_SelectObjectContent.html["Documentation AWS pour SelectObjectContent"^].
...
NOTE: L'utilisation de ScanRange n'est pas prise en charge.
